...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/eos/user/p/psuryade/SimOut/DeltaPt/step1_12_10_1.root')
    #fileNames = cms.untracked.vstring('file:/afs/cern.ch/user/p/psuryade/private/CMSSW/CMSSW_12_2_X_2021-11-09-1100/src/step1.root')
)
...
process.TFileService = cms.Service("TFileService",
     fileName = cms.string('/eos/user/p/psuryade/SimOut/DeltaPt/geantoutput_12_10_2.root')
 )
