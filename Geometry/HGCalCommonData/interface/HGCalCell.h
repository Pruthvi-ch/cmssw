...
public:
  ...
  //static constexpr int32_t intEdgeExtCell = 28;
  //static constexpr int32_t intEdgeTrunCell = 29;

  static constexpr int32_t halfTrunCell = 100;
  static constexpr int32_t halfExtCell = 101;
